...
| [Response Format](#response-format) | `response-format` | object | Response format. |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `type` | string |  Must be "json_object"   |
...
| [Usage](#usage) (optional) | `usage` | object | Usage statistics related to the query |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Images](#images) | `results` | array[object] | Generated results |
