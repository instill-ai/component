...
The OpenAI component is an AI component that allows users to connect the AI models served on the OpenAI Platform with standardized input and output formats..
...
The component configuration is defined and maintained [here](https://github.com/instill-ai/component/blob/main/ai/openai/v1/config/definition.json).
