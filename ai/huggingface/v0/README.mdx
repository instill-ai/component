...
| [Parameters](#parameters) | `parameters` | object | Parameters |
| [Options](#options) | `options` | object | Options for the model |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Results](#results) | `results` | array[object] | Results |
...
| Model (required) | `model` | string | The Hugging Face model to be used |
| [Inputs](#inputs) (required) | `inputs` | object | Inputs |
| [Options](#options) | `options` | object | Options for the model |
...
| [Table](#table) | `table` | object | A table of data represented as a dict of list where entries are headers and the lists are all the values, all lists must have the same size.  |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Conversation](#conversation) (optional) | `conversation` | object | A facility dictionary to send back for the next input (with the new user input addition). |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Classes](#classes) | `classes` | array[object] | Classes |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Segments](#segments) | `segments` | array[object] | Segments |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Objects](#objects) | `objects` | array[object] | Objects |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Box](#box) | `box` | object | A dict (with keys [xmin,ymin,xmax,ymax]) representing the bounding box of a detected object. |
