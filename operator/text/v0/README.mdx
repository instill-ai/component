...
| [Strategy](#strategy) (required) | `strategy` | object | Chunking strategy |
...
| :--- | :--- | :--- | :--- |
| [Setting](#setting) | `setting` | object | Chunk Setting  |
...
| [Text Chunks](#text-chunks) | `text-chunks` | array[object] | Text chunks after splitting |
