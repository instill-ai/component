...
| :--- | :--- | :--- | :--- |
| Pull Requests (optional) | `pull_requests` | array[object] | An array of PRs |
...
| Owner (required) | `owner` | string | owner of the repository |
| Repository (required) | `repository` | string | repository name |
| State | `state` | string | State of the issues, including open, closed, all. Default: open |
| Sort | `sort` | string | Sort the issues by created, updated, popularity, or long-running. Default: created |
| Direction | `direction` | string | Direction of the sort, including asc or desc. Default: asc |
| Since | `since` | string | Only issues updated at or after this time are returned. Default: 2021-01-01T00:00:00Z |
| No Pull Request | `no_pull_request` | boolean | Whether to not include pull requests in the issues. Default: false |
...
| Active | `active` | boolean | Whether the webhook is active |
| Content Type | `content_type` | string | Content type of the webhook |
