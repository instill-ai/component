...
| Image (required) | `image` | string | Input image |
| [Objects](#objects) (required) | `objects` | array[object] | A list of detected objects. |
| Show Score | `showScore` | boolean | Show model confidence score on each instance |
...
| :--- | :--- | :--- | :--- |
| [Bounding box](#bounding-box) | `bounding-box` | object | The detected bounding box in (left, top, width, height) format.  |
...
| Image (required) | `image` | string | Input image |
| [Objects](#objects) (required) | `objects` | array[object] | A list of keypoint objects, a keypoint object includes all the pre-defined keypoints of a detected object. |
| Show Score | `showScore` | boolean | Show model confidence score on each instance |
...
| :--- | :--- | :--- | :--- |
| [Bounding Box](#bounding-box) | `bounding-box` | object | The detected bounding box in (left, top, width, height) format.  |
| [Keypoints](#keypoints) | `keypoints` | array | A keypoint group is composed of a list of pre-defined keypoints of a detected object.  |
...
| Image (required) | `image` | string | Input image |
| [Objects](#objects) (required) | `objects` | array[object] | A list of detected bounding boxes. |
| Show Score | `showScore` | boolean | Show model confidence score on each instance |
...
| Image (required) | `image` | string | Input image |
| [Objects](#objects) (required) | `objects` | array[object] | A list of detected instance bounding boxes. |
| Show Score | `showScore` | boolean | Show model confidence score on each instance |
...
| Image (required) | `image` | string | Input image |
| Show Score | `showScore` | boolean | Show model confidence score on each instance |
| [Stuffs](#stuffs) (required) | `stuffs` | array[object] | A list of RLE binary masks. |
