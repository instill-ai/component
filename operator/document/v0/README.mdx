...
lang: "en-US"
draft: false
description: "Learn about how to set up a VDP Document operator https://github.com/instill-ai/instill-core"
---

The Document component is an operator that allows users to manipulate Document files.
