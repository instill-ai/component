...
lang: "en-US"
draft: false
description: "Learn about how to set up a VDP Pinecone operator https://github.com/instill-ai/instill-core"
---

The Pinecone component is an operator that allows users to build and search vector datasets.
