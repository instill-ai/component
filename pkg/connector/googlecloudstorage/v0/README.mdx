...
lang: "en-US"
draft: false
description: "Learn about how to set up a VDP Google Cloud Storage operator https://github.com/instill-ai/instill-core"
---

The Google Cloud Storage component is an operator that allows users to upload data to Google's Cloud Storage.
