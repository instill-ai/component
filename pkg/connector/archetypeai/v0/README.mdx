...
lang: "en-US"
draft: false
description: "Learn about how to set up a VDP Archetype AI operator https://github.com/instill-ai/instill-core"
---

The Archetype AI component is an operator that allows users to connect the AI models served on the Archetype AI Platform.
