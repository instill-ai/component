...
//go:generate minimock -i github.com/instill-ai/component/application/freshdesk/v0.FreshdeskInterface -o freshdesk_interface_mock_test.go -n FreshdeskInterfaceMock -p freshdesk
