...
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_GOAL` |
...
| Goal Note (optional) | `note` | string | The note of the goal. |
| Goal HTML Note (optional) | `html-note` | string | The note of the goal in HTML format. |
...
| Input | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_TASK` |
| Action | `action` | object | Action |
...
| Input | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_PROJECT` |
| Action | `action` | object | action |
...
| Project Note (optional) | `note` | string | The note of the project. |
| Project HTML Note (optional) | `html-note` | string | The note of the project in HTML format. |
...
| Input | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_PORTFOLIO` |
| Action | `action` | object | action |
