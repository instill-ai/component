...
| [Action](#action) | `action` | object | action |



<details>
<summary> Input Objects in Crud Goal</summary>
...
| Status | `status` | string |  The current status of this goal. When the goal is open, its status can be green, yellow, and red to reflect "On Track", "At Risk", and "Off Track", respectively. When the goal is closed, the value can be missed, achieved, partial, or dropped.   <br/>Enum: <br/><ul><li>green</li><li>yellow</li><li>red</li><li>missed</li><li>achieved</li><li>partial</li><li>dropped</li></ul>  |
...
| [Owner](#owner) (optional) | `owner` | object | The owner of the goal. |
...
| [Likes](#likes) (optional) | `likes` | array[object] | The users who likes the goal. |
...
<details>
<summary> Input Objects in Crud Task</summary>
...
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "update"   |
| Approval Status | `approval-status` | string |  The approval status of the task. If you set completed to true, this field will be set to approved.   <br/>Enum: <br/><ul><li>pending</li><li>approved</li><li>rejected</li><li>changes_requested</li></ul>  |
...
| Resource Subtype | `resource-subtype` | string |  The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.   <br/>Enum: <br/><ul><li>default_task</li><li>milestone</li><li>section</li><li>approval</li></ul>  |
| Task ID | `task-gid` | string |  Globally unique identifier (GID) for the task.   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "duplicate"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "set parent"   |
| Parent Task | `parent` | string |  GID of the parent task.   |
| Task ID | `task-gid` | string |  Globally unique identifier (GID) for the task.   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "edit tag"   |
| Edit option | `edit-option` | string |  Edit option. You can choose to add or remove the tag.   <br/>Enum: <br/><ul><li>add</li><li>remove</li></ul>  |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "edit follower"   |
| Edit option | `edit-option` | string |  Edit option. You can choose to add or remove the follower.   <br/>Enum: <br/><ul><li>add</li><li>remove</li></ul>  |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "edit project"   |
| Edit option | `edit-option` | string |  Edit option. You can choose to add or remove the project.   <br/>Enum: <br/><ul><li>add</li><li>remove</li></ul>  |
...
| [Projects](#projects) (optional) | `projects` | array[object] | The projects of the task. |
...
| [Likes](#likes) (optional) | `likes` | array[object] | The users who likes the task. |
...
<details>
<summary> Input Objects in Crud Project</summary>
...
| Update Color | `color` | string |  The color of the project.   <br/>Enum: <br/><ul><li>dark_pink</li><li>dark_green</li><li>dark_blue</li><li>dark_red</li><li>dark_teal</li><li>dark_brown</li><li>dark_orange</li><li>dark_purple</li><li>dark_warm_gray</li><li>light_pink</li><li>light_green</li><li>light_blue</li><li>light_red</li><li>light_teal</li><li>light_brown</li><li>light_orange</li><li>light_purple</li><li>light_warm_gray</li><li>none</li><li>null</li></ul>  |
...
| Update Privacy Setting | `privacy-setting` | string |  The privacy setting of the project.   <br/>Enum: <br/><ul><li>public to workspace</li><li>private to team</li><li>private</li></ul>  |
| Project ID | `project-gid` | string |  Globally unique identifier (GID) for the project.   |
...
| [Owner](#owner) (optional) | `owner` | object | The owner of the project. |
...
| [Completed By](#completed-by) (optional) | `completed-by` | object | The user who completed the project. |
| [Current Status](#current-status) (optional) | `current-status` | object | The current status of the project. |
| [Custom Fields](#custom-fields) (optional) | `custom-fields` | object | The custom fields of the project. |
| [Custom Field Settings](#custom-field-settings) (optional) | `custom-field-settings` | object | The custom field settings of the project. |
...
<details>
<summary> Input Objects in Crud Portfolio</summary>
...
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "update"   |
| Update Color | `color` | string |  The color of the portfolio.   <br/>Enum: <br/><ul><li>dark_pink</li><li>dark_green</li><li>dark_blue</li><li>dark_red</li><li>dark_teal</li><li>dark_brown</li><li>dark_orange</li><li>dark_purple</li><li>dark_warm_gray</li><li>light_pink</li><li>light_green</li><li>light_blue</li><li>light_red</li><li>light_teal</li><li>light_brown</li><li>light_orange</li><li>light_purple</li><li>light_warm_gray</li><li>none</li><li>null</li></ul>  |
...
| :--- | :--- | :--- | :--- |
|  | `action` | string |  Must be "create"   |
| Color | `color` | string |  The color of the portfolio.   <br/>Enum: <br/><ul><li>dark_pink</li><li>dark_green</li><li>dark_blue</li><li>dark_red</li><li>dark_teal</li><li>dark_brown</li><li>dark_orange</li><li>dark_purple</li><li>dark_warm_gray</li><li>light_pink</li><li>light_green</li><li>light_blue</li><li>light_red</li><li>light_teal</li><li>light_brown</li><li>light_orange</li><li>light_purple</li><li>light_warm_gray</li><li>none</li><li>null</li></ul>  |
| Portfolio Name | `name` | string |  The name of the portfolio.   |
| Public | `public` | boolean |  Whether the portfolio is public.   |
| Workspace | `workspace` | string |  The workspace of the portfolio. Please fill in the Globally unique identifier (GID) for the workspace.   |
...
| [Owner](#owner) (optional) | `owner` | object | The owner of the portfolio. |
...
| [Created By](#created-by) (optional) | `created-by` | object | The user who created the portfolio. |
| [Current Status](#current-status) (optional) | `current-status` | object | The current status of the portfolio. |
| [Custom Fields](#custom-fields) (optional) | `custom-fields` | object | The custom fields of the portfolio. |
| [Custom Field Settings](#custom-field-settings) (optional) | `custom-field-settings` | object | The custom field settings of the portfolio. |
