...
| Status | `status` | string |  The current status of this goal. When the goal is open, its status can be green, yellow, and red to reflect "On Track", "At Risk", and "Off Track", respectively. When the goal is closed, the value can be missed, achieved, partial, or dropped.   <br/><details> <summary>Enum: </summary><ul><li>green</li><li>yellow</li><li>red</li><li>missed</li><li>achieved</li><li>partial</li><li>dropped</li></ul></details>  |
...
| :--- | :--- | :--- | :--- |
| Action | `action` | string |  Must be "update"   |
| Update Color | `color` | string |  The color of the portfolio.   <br/><details> <summary>Enum: </summary><ul><li>dark_pink</li><li>dark_green</li><li>dark_blue</li><li>dark_red</li><li>dark_teal</li><li>dark_brown</li><li>dark_orange</li><li>dark_purple</li><li>dark_warm_gray</li><li>light_pink</li><li>light_green</li><li>light_blue</li><li>light_red</li><li>light_teal</li><li>light_brown</li><li>light_orange</li><li>light_purple</li><li>light_warm_gray</li><li>none</li><li>null</li></ul></details>  |
...
| :--- | :--- | :--- | :--- |
| Action | `action` | string |  Must be "create"   |
| Color | `color` | string |  The color of the portfolio.   <br/><details> <summary>Enum: </summary><ul><li>dark_pink</li><li>dark_green</li><li>dark_blue</li><li>dark_red</li><li>dark_teal</li><li>dark_brown</li><li>dark_orange</li><li>dark_purple</li><li>dark_warm_gray</li><li>light_pink</li><li>light_green</li><li>light_blue</li><li>light_red</li><li>light_teal</li><li>light_brown</li><li>light_orange</li><li>light_purple</li><li>light_warm_gray</li><li>none</li><li>null</li></ul></details>  |
| Portfolio Name | `name` | string |  The name of the portfolio.   |
| Public | `public` | boolean |  Whether the portfolio is public.   |
| Workspace | `workspace` | string |  The workspace of the portfolio. Please fill in the Globally unique identifier (GID) for the workspace.   |
