...
| :--- | :--- | :--- | :--- |
| [Boards](#boards) (optional) | `boards` | array[object] | A array of boards in Jira |
...
| [Range](#range) | `range` | object | Choose the range of issues to return. Default is `all` |
| Start At | `start-at` | integer | The starting index of the returned boards. Base index: 0. Default is 0 |
| Max Results | `max-results` | integer | The maximum number of boards to return. Default is 50 |
...
<details>
<summary> Input Objects in List Issues</summary>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `range` | string |  Must be "Standard Issues"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `range` | string |  Must be "Epics only"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `range` | string |  Must be "In backlog only"   |
...
|  | `range` | string |  Must be "Issues of an epic"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `range` | string |  Must be "Issues of a sprint"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `range` | string |  Must be "Issues without epic assigned"   |
...
|  | `range` | string |  Must be "JQL query"   |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Issues](#issues) (optional) | `issues` | array[object] | A array of issues in Jira |
| Start At | `start-at` | integer | The starting index of the returned boards. Base index: 0 |
| Max Results | `max-results` | integer | The maximum number of boards |
| Total | `total` | integer | The total number of boards |
...
| [Fields](#fields) | `fields` | object | The fields of the issue. All navigable and Agile fields are returned |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Sprints](#sprints) (optional) | `sprints` | array[object] | A array of sprints in Jira |
| Start At | `start-at` | integer | The starting index of the returned boards. Base index: 0 |
| Max Results | `max-results` | integer | The maximum number of boards |
| Total | `total` | integer | The total number of boards |
...
<details>
<summary> Output Objects in Get Issue</summary>
...
| [Issue Type](#issue-type) (required) | `issue-type` | object | The type of the issue, can be: `Task`, `Epic`, `Subtask`, etc. |
| Summary | `summary` | string | The summary of the issue |
| Description | `description` | string | The description of the issue |
...
<details>
<summary> Input Objects in Create Issue</summary>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `issue-type` | string |  Must be "Epic"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `issue-type` | string |  Must be "Task"   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `issue-type` | string |  Must be "Subtask"   |
...
|  | `issue-type` | string |  Must be "Other"   |
...
<details>
<summary> Output Objects in Create Issue</summary>
...
| [Update](#update) | `update` | object | Update an issue in Jira |



<details>
<summary> Input Objects in Update Issue</summary>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `update` | string |  Must be "Custom Update"   |
| [Update Fields](#update-fields) | `update-fields` | array |  The fields to update   |
...
| :--- | :--- | :--- | :--- |
| Epic Key | `epic-key` | string |  The key of the epic, e.g. `JRA-1330`   |
|  | `update` | string |  Must be "Move Issue to Epic"   |
...
<details>
<summary> Output Objects in Update Issue</summary>
