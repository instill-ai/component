...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Messages](#messages) | `results` | array[object] | An array of messages |
...
| [Recipients](#recipients) | `recipients` | array | Recipients' information |
| [Sender](#sender) | `sender` | object | Sender's information |
...
| [Teams](#teams) (optional) | `teams` | array[object] | The owner's teams information |
