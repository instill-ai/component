...
lang: "en-US"
draft: false
description: "Learn about how to set up a VDP WhatsApp component https://github.com/instill-ai/instill-core"
---
...
The component definition and tasks are defined in the [definition.json](https://github.com/instill-ai/component/blob/main/application/whatsapp/v0/config/definition.json) and [tasks.json](https://github.com/instill-ai/component/blob/main/application/whatsapp/v0/config/tasks.json) files respectively.
