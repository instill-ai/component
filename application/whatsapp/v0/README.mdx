...
The component configuration is defined and maintained [here](https://github.com/instill-ai/component/blob/main/application/whatsapp/v0/config/definition.json).
...
| Phone Number ID (required) | `phone-number-id` | string | Phone Number ID. Obtainable through the app dashboard. |
