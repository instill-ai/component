...
| [Filter](#filter) | `filter` | object | The filter to apply. You can use vector metadata to limit your search. See more details <a href="https://www.pinecone.io/docs/metadata-filtering/">here</a>. |
...
| [Matches](#matches) | `matches` | array[object] | The matches returned for the query |
...
| [Metadata](#metadata) | `metadata` | object | Metadata |
...
| Namespace | `namespace` | string | The namespace to query |
| [Metadata](#metadata) | `metadata` | object | The vector metadata |
