...
| [Array Metadata](#array-metadata) (required) | `array-metadata` | array[object] | The array of vector metadata |
...
| [Metadata](#metadata) (required) | `metadata` | object | The vector metadata |
...
| [Filter](#filter) | `filter` | object | The metadata filter to be applied to the data with Chroma where filter, please refer to [using-where-filters](https://docs.trychroma.com/guides#using-where-filters) |
...
<details>
<summary> Input Objects in Query</summary>
...
| [Items](#items) | `items` | array | The items returned from the vector search operation |
...
| [Config](#config) | `metadata` | object | The metadata of the collection. Please refer to [creating-inspecting-and-deleting-collection](https://docs.trychroma.com/guides#creating,-inspecting,-and-deleting-collections) |
| [Configuration](#configuration) | `configuration` | object | The configuration of the collection. Please refer to [creating-inspecting-and-deleting-collection](https://docs.trychroma.com/guides#creating,-inspecting,-and-deleting-collections) |
