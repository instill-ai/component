...
| Qdrant URL Endpoint (required) | `url` | string | Fill in your Chroma hosted public URL endpoint with port, e.g http://1.2.3:8000 |
...
| Filter | `filter` | object | The metadata filter to be applied to the data with Chroma where filter, please refer to https://docs.trychroma.com/guides#using-where-filters |
| Filter Document | `filter-document` | string | The document content filter to be applied to the data, please refer to https://docs.trychroma.com/guides#filtering-by-document-contents |
...
| Config | `metadata` | object | The metadata of the collection. Please refer to https://docs.trychroma.com/guides#creating,-inspecting,-and-deleting-collections |
| Configuration | `configuration` | object | The configuration of the collection. Please refer to https://docs.trychroma.com/guides#creating,-inspecting,-and-deleting-collections |
