...
| Collection | `collection-name` | string | The collection to be deleted |
...
| Input | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_DELETE_DATABASE` |
| Database | `database-name` | string | The database to be deleted |
