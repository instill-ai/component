...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Filter | `filter` | semi-structured/json | The filter to find documents, this field is optional, support mongodb query, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/ |
...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Filter (required) | `filter` | semi-structured/json | The filter to update documents, support mongodb query, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/ |
| Update (required) | `update-data` | semi-structured/json | The updated data to be applied to the documents |
...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Filter (required) | `filter` | semi-structured/json | The filter to delete documents, support mongodb query, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/ |
...
| Syntax (required) | `syntax` | semi-structured/json | The syntax structure of the search index, please refer to the MongoDB documentation for more information. search https://www.mongodb.com/docs/atlas/atlas-search/create-index/. vectorSearch https://www.mongodb.com/docs/atlas/atlas-vector-search/vector-search-type/ |
...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Index Name (required) | `index-name` | string | The name of the index to be deleted |
...
| Filter | `filter` | semi-structured/json | The filter to be used for vector search, need to first create filter vectorSearch search index, support mongodb query, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/ to be used for vector search |
| Fields | `fields` | array:string | The fields to return in the documents. If empty then all fields will be returned |
