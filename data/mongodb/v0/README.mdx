...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Criteria (required) | `criteria` | any | The criteria to find documents, if JSON value of a key is null e.g \{'name':null\}, then name field will be selected without any criteria, if JSON is empty e.g \{\}, then all fields will be selected |
...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Criteria (required) | `criteria` | any | The criteria to update documents |
| Update (required) | `update` | any | The updated data to be applied to the documents |
...
| Database Name (required) | `database-name` | string | Fill in your MongoDB database name |
| Collection Name (required) | `collection-name` | string | The name of the collection in the MongoDB database |
| Criteria (required) | `criteria` | any | The criteria to delete documents |
