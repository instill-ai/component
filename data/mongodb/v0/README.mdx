...
| [Data](#data) (required) | `data` | object | The data to be inserted |
...
| Collection Name (required) | `collection-name` | string | The name of the collection in MongoDB |
| ID | `id` | string | The ID of the document |
| [Filter](#filter) | `filter` | object | The filter to find documents, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/. If empty then all documents will be returned |
...
<details>
<summary> Input Objects in Find</summary>
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Result](#result) | `result` | object | Result of the find operation |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Metadata](#metadata) | `data` | array | The data returned from the find operation |
| [Documents](#documents) | `documents` | array | The documents returned from the find operation |
...
| Collection Name (required) | `collection-name` | string | The name of the collection in MongoDB |
| ID | `id` | string | The ID of the document |
| [Filter](#filter) | `filter` | object | The filter to update documents, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/. If empty then all documents will be returned |
| [Update](#update) (required) | `update-data` | object | The updated data to be applied to the documents |
...
| Collection Name (required) | `collection-name` | string | The name of the collection in MongoDB |
| ID | `id` | string | The ID of the document |
| [Filter](#filter) | `filter` | object | The filter to delete documents, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/. If empty then all documents will be returned |
...
| [Syntax](#syntax) (required) | `syntax` | object | The syntax structure of the search index, please refer to the MongoDB documentation for more information. search https://www.mongodb.com/docs/atlas/atlas-search/create-index/. vectorSearch https://www.mongodb.com/docs/atlas/atlas-vector-search/vector-search-type/ |



<details>
<summary> Input Objects in Create Search Index</summary>
...
| [Filter](#filter) | `filter` | object | The filter to be used for vector search, need to first create filter vectorSearch search index, please refer to the documentations https://www.mongodb.com/docs/manual/reference/operator/query/. If empty then all documents will be returned to be used for vector search |
| Fields | `fields` | array[string] | The fields to return in the documents. If empty then all fields will be returned |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Documents](#documents) | `documents` | array | The documents returned from the vector search operation |
