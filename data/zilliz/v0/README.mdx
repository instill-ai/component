...
| :--- | :--- | :--- | :--- |
| Zilliz URL Endpoint (required) | `url` | string | Fill in your Zilliz public URL endpoint with port number, e.g http://3.25.202.142:19530 |
...
| Filter | `filter` | string | The properties filter to be applied to the data with zilliz scalar filter, please refer to https://zilliz.io/docs/single-vector-search.md#Filtered-search |
| Offset | `offset` | integer | The offset of the data to return |
| Grouping Field | `grouping-field` | string | The name of the field to group the data by |
| Search Parameters | `search-params` | object | The search parameters to be applied to the data with zilliz search parameters, please refer to https://zilliz.io/docs/single-vector-search.md#Search-parameters |
