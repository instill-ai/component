...
The component configuration is defined and maintained [here](https://github.com/instill-ai/component/blob/main/data/instillartifact/v0/config/definition.json).
