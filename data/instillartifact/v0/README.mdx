...
The component definition and tasks are defined in the [definition.json](https://github.com/instill-ai/component/blob/main/data/instillartifact/v0/config/definition.json) and [tasks.json](https://github.com/instill-ai/component/blob/main/data/instillartifact/v0/config/tasks.json) files respectively.
