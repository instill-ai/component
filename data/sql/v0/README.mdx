...
| :--- | :--- | :--- | :--- |
| Engine (required) | `engine` | string | Choose the engine of your database.  <br/><details> <summary>Enum: </summary><ul><li>MySQL</li><li>PostgreSQL</li><li>SQL Server</li><li>Oracle</li><li>MariaDB</li><li>Firebird</li></ul></details>  |
