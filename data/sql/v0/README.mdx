...
| :--- | :--- | :--- | :--- |
| Engine (required) | `engine` | string | Choose the engine of your database.  There are options: <br/>- MySQL<br/>- PostgreSQL<br/>- SQL Server<br/>- Oracle<br/>- MariaDB<br/>- Firebird   |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  ssl-tls-type   | ssl-tls-type | string |  please intput  "NO TLS"   |
...
|  ssl-tls-type   | ssl-tls-type | string |  please intput  "TLS"   |
...
|  ssl-tls-type   | ssl-tls-type | string |  please intput  "mTLS"   |
