...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
|  | `ssl-tls-type` | string |  Must be "NO TLS"   |
...
|  | `ssl-tls-type` | string |  Must be "TLS"   |
...
|  | `ssl-tls-type` | string |  Must be "mTLS"   |
...
| [Update](#update) (required) | `update-data` | object | The new data to be updated to |
...
| [Columns](#columns) (required) | `columns-structure` | object | The columns structure to be created in the table, json with value string, e.g \{"name": "VARCHAR(255)", "age": "INT not null"\} |



<details>
<summary> Input Objects in Create Table</summary>
