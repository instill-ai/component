...
func (m *MockAWSRDSClient) GetConversations(params *slack.GetConversationsParameters) ([]slack.Channel, string, error) {
...
func (m *MockAWSRDSClient) PostMessage(channelID string, options ...slack.MsgOption) (string, string, error) {

	return "", "", nil
}

func (m *MockAWSRDSClient) GetConversationHistory(params *slack.GetConversationHistoryParameters) (*slack.GetConversationHistoryResponse, error) {
...
func (m *MockAWSRDSClient) GetConversationReplies(params *slack.GetConversationRepliesParameters) ([]slack.Message, bool, string, error) {
...
func (m *MockAWSRDSClient) GetUsersInfo(users ...string) (*[]slack.User, error) {
	resp := &[]slack.User{
		{
			ID:   "user123",
			Name: "Penguin",
...
func TestComponent_ExecuteUpsert(t *testing.T) {
	c := qt.New(t)
