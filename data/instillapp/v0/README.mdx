...
The Instill App component is a data component that allows users to manipulate Instill App related resources..
...
The component configuration is defined and maintained [here](https://github.com/instill-ai/component/blob/main/data/instillapp/v0/config/definition.json).
...
| :--- | :--- | :--- | :--- |
| API Token | `api-token` | string | Fill in your API Tokens. It is only for CE version. In Cloud, you do not need to fill this field. You can create an api token in [Settings > API Tokens](https://instill.tech/settings/profile).   |
