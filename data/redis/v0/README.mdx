...
| :--- | :--- | :--- | :--- |
| [Chat Message](#chat-message) | `messages` | array[object] | Messages |
...
| [Metadata](#metadata) | `metadata` | object | The message metadata |
...
<details>
<summary> Input Objects in Write Multi Modal Chat Message</summary>
