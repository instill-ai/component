...
| [Filter](#filter) | `filter` | object | The query dsl filter which starts with "query" field, please refer to https://www.elastic.co/guide/en/elasticsearch/reference/current/query-filter-context.html |
...
<details>
<summary> Input Objects in Search</summary>
...
| [Result](#result) | `result` | object | Result of the search operation |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Data](#data) | `data` | array | The data returned from the search operation |
| [Documents](#documents) | `documents` | array | The documents returned from the search operation |
...
| [Filter](#filter) | `filter` | object | The query dsl filter which starts with "filter" field, please refer to https://www.elastic.co/guide/en/elasticsearch/reference/current/knn-search.html#knn-search-filter-example |
| Filter SQL | `filter-sql` | string | The filter to be applied to the data with SQL syntax, which starts with WHERE clause, empty for no filter |
| Fields | `fields` | array[string] | The fields to return in the documents. If empty then all fields will be returned |
| Minimum Score | `min-score` | number | Minimum score to consider for search results. If empty then no minimum score will be considered |
...
| Index Name (required) | `index-name` | string | Name of the Elasticsearch index |
| ID | `id` | string | The ID of the document |
| [Data](#data) (required) | `data` | object | Data to be indexed |



<details>
<summary> Input Objects in Index</summary>
...
| [Array Data](#array-data) (required) | `array-data` | array[object] | Array data to be indexed |



<details>
<summary> Input Objects in Multi Index</summary>
...
| [Filter](#filter) | `filter` | object | The query dsl filter which starts with "query" field, please refer to https://www.elastic.co/guide/en/elasticsearch/reference/current/query-filter-context.html |
| Filter SQL | `filter-sql` | string | The filter to be applied to the data with SQL syntax, which starts with WHERE clause, empty for no filter |
| [Update](#update) (required) | `update-data` | object | Update data |
