...
| [Search Parameters](#search-parameters) | `search-params` | object | The search parameters to be applied to the data with milvus search parameters, please refer to [Search-parameters](https://milvus.io/docs/single-vector-search.md#Search-parameters) |
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Data](#data) | `data` | array | The points returned from the vector search operation |
...
| [Data](#data) (required) | `data` | object | The data |



<details>
<summary> Input Objects in Upsert</summary>
...
| Collection Name (required) | `collection-name` | string | The name of the collection to upsert the data into |
| Partition Name | `partition-name` | string | The name of the partition to upsert the data from. If empty then default partition will be used |
| [Array Data](#array-data) (required) | `array-data` | array[object] | The data |
...
| [Schema](#schema) | `schema` | object | The schema of the collection |
| Auto ID | `auto-id` | boolean | Whether to auto generate id |
| Metric Type | `metric-type` | string | The metric type of the collection |
| [Index Parameters](#index-parameters) | `index-params` | array[object] | The index parameters to be applied to the collection with milvus index parameters, please refer to [Create](https://milvus.io/api-reference/restful/v2.4.x/v2/Collection%20(v2)/Create.md) |
| [Parameters](#parameters) | `params` | object | The parameters to be applied to the collection with milvus parameters, please refer to [Parameters](https://milvus.io/docs/single-vector-search.md#Parameters) |



<details>
<summary> Input Objects in Create Collection</summary>
...
| [Index Parameters](#index-parameters) (required) | `index-params` | object | The index parameters to be applied to the collection with milvus index parameters, please refer to [Create](https://milvus.io/api-reference/restful/v2.4.x/v2/Index%20(v2)/Create.md) |



<details>
<summary> Input Objects in Create Index</summary>
