...
The component configuration is defined and maintained [here](https://github.com/instill-ai/component/blob/main/data/qdrant/v0/config/definition.json).
...
| [Filter](#filter) | `filter` | object | The properties filter to be applied to the data with Qdrant filter, please refer to https://api.qdrant.tech/api-reference/search/points filter section |
| [Params](#params) | `params` | object | The additional parameters to be passed to the search, please refer to https://api.qdrant.tech/api-reference/search/points params section |
...
| [Points](#points) | `points` | array | The points returned from the vector search operation |
...
| [Array Metadata](#array-metadata) | `array-metadata` | array[object] | The array of vector metadata payload |
...
| [Metadata](#metadata) | `metadata` | object | The vector metadata payload |
...
| [Filter](#filter) | `filter` | object | The properties filter to be applied to the data with Qdrant filter, please refer to https://api.qdrant.tech/api-reference/points/delete-points filter section |
| Ordering | `ordering` | string | The ordering guarantees of the batch upsert |
...
| [Config](#config) (required) | `config` | object | The configuration of the collection. Please refer to https://api.qdrant.tech/api-reference/collections/create-collection |
