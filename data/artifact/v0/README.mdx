...
| [Options](#options) (required) | `options` | object | Choose to upload the files to existing catalog or create a new catalog |



<details>
<summary> Input Objects in Upload File</summary>
...
| Existing Catalog | `option` | string |  Must be "existing catalog"   |
...
| File Name | `file-name` | string |  The name of the file, please remember to add the file extension in the end of file name. e.g. 'example.pdf'   |
| Namespace | `namespace` | string |  Fill in your namespace, you can get namespace through the tab of switching namespace   |
| Create New Catalog | `option` | string |  Must be "create new catalog"   |
...
| :--- | :--- | :--- | :--- |
| [File](#file) | `file` | object | Result of uploading file into catalog |
...
<details>
<summary> Input Objects in Upload Files</summary>
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Files](#files) | `files` | array[object] | Files metadata in catalog |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Chunks](#chunks) | `chunks` | array[object] | Chunks metadata of the file in catalog |
...
| Output | ID | Type | Description |
| :--- | :--- | :--- | :--- |
| [Chunks](#chunks) | `chunks` | array[object] | Chunks data from smart search |
...
| [Chunks](#chunks) (optional) | `chunks` | array[object] | Chunks data to answer question |
