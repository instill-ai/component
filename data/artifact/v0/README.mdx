...
| Duration | `duration` | string | The duration between now and how long ago to retrieve the chat history from in D,H,M format i.e. 1.0.0 means 1 day ago. Default is all blank. |
